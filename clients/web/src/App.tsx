...
export default function App (): JSX.Element {
  ...
  return (
    <div className="app">
                ...
                <div className="thumb-upload-area">
                  {thumbPreview != null
                    ...
                    <div className="thumb-preview">
                      ...
                      <button type="button" className="thumb-remove" onClick={() => { setNewThumb(null); setThumbPreview(null) }} aria-label={t('removeThumbnail')}>×</button>
                    </div>
                      )
                    : (
      ...
      {toast != null && <div className={`toast ${toast.type}`}><span>{toast.text}</span><button className="toast-x" onClick={() => { setToast(null) }} aria-label={t('close')}>×</button></div>}
    </div>
  )
}
