...
export function WatchPage ({ stream, user, onBack, onRefresh, onDelete, onNavigateDashboard }: Props): JSX.Element {
  const { t } = useI18n()
          ...
          <div className="watch-actions">
            ...
            {isOwner && (
              <>
                ...
                <button className="btn-icon" onClick={onNavigateDashboard} title={t('dashboard')}>
