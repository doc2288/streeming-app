        ...
        <div className="watch-info">
          ...
          <div className="watch-actions">
            <div className="quality-picker" style={{ position: 'relative' }}>
              <button className="btn-icon" onClick={() => { setShowQuality(!showQuality) }} title={t('viewers_quality')} aria-label={t('viewers_quality')} aria-expanded={showQuality} aria-haspopup="true">
