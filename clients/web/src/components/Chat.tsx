  ...
  return (
    <div className="chat-panel">
      ...
      <div className="chat-input-area">
        <button className="chat-emoji-toggle" onClick={() => { setShowEmoji(!showEmoji) }} aria-label={t('emoji')} title={t('emoji')}>
        ...
        <button onClick={send} disabled={!connected || text.trim().length === 0} className="chat-send" aria-label={t('send')} title={t('send')}>
