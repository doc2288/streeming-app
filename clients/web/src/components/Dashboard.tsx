            ...
            <div key={s.id} className={`dash-card ${s.status === 'live' ? 'dash-card-live' : ''}`}>
              ...
              <div className="dash-keys">
                ...
                <div className="dash-key-row">
                  ...
                  <button className="btn-copy" onClick={() => { copy(s.ingest_url) }} title="Copy" aria-label="Copy">
                ...
                <div className="dash-key-row">
                  ...
                  {visibleKeys.has(s.id) && (
                    <button className="btn-copy" onClick={() => { copy(s.stream_key) }} title="Copy" aria-label="Copy">
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="9" y="9" width="13" height="13" rx="2" /><path d="M5 15H4a2 2 0 01-2-2V4a2 2 0 012-2h9a2 2 0 012 2v1" /></svg>
                    </button>
                  )}
                </div>
