  ...
  return (
    <nav className="topbar">
      <div className="topbar-left">
        <button className="topbar-hamburger" onClick={onToggleSidebar} title={t('menuAction')} aria-label={t('menuAction')}>
      ...
      <form className="topbar-search" onSubmit={(e) => { e.preventDefault(); onSearch(query.trim()) }}>
        ...
        <button type="submit" className="search-btn" title={t('searchAction')} aria-label={t('searchAction')}>
