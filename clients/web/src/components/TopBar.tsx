  ...
  return (
    <nav className="topbar">
      <div className="topbar-left">
        ...
        <button className="topbar-logo" onClick={onNavigateHome} aria-label={t('home')}>
      ...
      <form className="topbar-search" onSubmit={(e) => { e.preventDefault(); onSearch(query.trim()) }}>
        ...
        {query.length > 0 && (
          <button type="button" className="search-clear" onClick={() => { setQuery(''); onSearch('') }} aria-label={t('hide')}>×</button>
        )}
